 ...
 */
final class Version20210629074504 extends AbstractMigration
{
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE order_product ADD CONSTRAINT FK_2530ADE64584665A FOREIGN KEY (product_id) REFERENCES orderHasProducts (id) ON UPDATE NO ACTION ON DELETE CASCADE');
